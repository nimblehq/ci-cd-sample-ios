...
class DeliverableConstants
  ...
  def self.GSP_STAGING
    './WeatherToday/Configurations/Plists/GoogleService/Staging/GoogleService-Info.plist'
  end

  # a gsp file name for production
  def self.GSP_PRODUCTION
    './WeatherToday/Configurations/Plists/GoogleService/Production/GoogleService-Info.plist'
  end
